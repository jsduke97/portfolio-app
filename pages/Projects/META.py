...
with col2:
    st.link_button("Read the Report", "https://github.com/jsduke97/Facebook-Ad-Impact-2020-Election/blob/main/Meta_Ad_Impact_2020_Election_REPORT.pdf", use_container_width = True)
    st.link_button("View the Presentation", "https://github.com/jsduke97/Facebook-Ad-Impact-2020-Election/blob/main/Meta_Ad_Impact_2020_Election_PRESENTATION.pdf", use_container_width = True)
    st.link_button("View the Project Code", "https://github.com/jsduke97/Facebook-Ad-Impact-2020-Election/blob/main/Meta_Ad_Impact_2020_Election_CODE.ipynb", use_container_width = True)